            ...
            server = {
                on_attach = function(_, bufnr)
                    ...
                    local maps = {
                        ...
                        { "n", "<leader>rR", function() vim.cmd.RustLsp('runnables') end,                            "Rust Open Runnables" },
                        { "n", "<leader>rB", function() vim.cmd.RustLsp('debuggables') end,                          "Rust Open Debuggables" },
                        ...
                        { "n", "<leader>rM", function() vim.cmd.RustLsp { 'view', 'hir' } end,                       "Rust View Hir" },
                        { "n", "<leader>rH", function() vim.cmd.RustLsp { 'view', 'mir' } end,                       "Rust View Mir" },
                        { "n", "<leader>rd", function() vim.cmd.RustLsp({ 'renderDiagnostic', 'current' }) end,      "Rust Open Diagnostic" },
                        { "n", "<leader>rH", function() vim.cmd.RustLsp { 'crateGraph', '[backend]', '[output]' } end, "Rust View Mir" },
                    }
