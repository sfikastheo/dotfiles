...
autoload_if_exists zoxide 'eval "$(zoxide init --cmd to zsh)"'
autoload_if_exists starship 'eval "$(starship init zsh)"'
autoload_if_exists direnv 'eval "$(direnv hook zsh)"'
autoload_if_exists lazygit 'alias lg="lazygit"'
autoload_if_exists yazi 'alias ya="yazi"'
